...
import { getPokemonData, getPokemons, pokemon, pokemondata, searchPokemon } from "./api";
...
export default function App() {
  ...
  const fetchPokemons = async () => {
    try {
      ...
      const results = await Promise.all(promises) as pokemondata[];
      setPokemons(results);
      setLoading(false);
        ...
        <div className="App">
          ...
          {notFound ? (
            <div className="not-found-text">
              Pokemon not existing in the database.
